        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(Character::EquipmentHead).integer())
                    .col(ColumnDef::new(Character::EquipmentNeck).integer())
                    .col(ColumnDef::new(Character::EquipmentShoulders).integer())
                    .col(ColumnDef::new(Character::EquipmentBody).integer())
                    .col(ColumnDef::new(Character::EquipmentChest).integer())
                    .col(ColumnDef::new(Character::EquipmentWaist).integer())
                    .col(ColumnDef::new(Character::EquipmentLegs).integer())
                    .col(ColumnDef::new(Character::EquipmentFeet).integer())
                    .col(ColumnDef::new(Character::EquipmentWrists).integer())
                    .col(ColumnDef::new(Character::EquipmentHands).integer())
                    .col(ColumnDef::new(Character::EquipmentFinger1).integer())
                    .col(ColumnDef::new(Character::EquipmentFinger2).integer())
                    .col(ColumnDef::new(Character::EquipmentTrinket1).integer())
                    .col(ColumnDef::new(Character::EquipmentTrinket2).integer())
                    .col(ColumnDef::new(Character::EquipmentBack).integer())
                    .col(ColumnDef::new(Character::EquipmentMainhand).integer())
                    .col(ColumnDef::new(Character::EquipmentOffhand).integer())
                    .col(ColumnDef::new(Character::EquipmentRanged).integer())
                    .col(ColumnDef::new(Character::EquipmentTabard).integer())
                    .col(ColumnDef::new(Character::Bag1).integer())
                    .col(ColumnDef::new(Character::Bag2).integer())
                    .col(ColumnDef::new(Character::Bag3).integer())
                    .col(ColumnDef::new(Character::Bag4).integer())
                    .col(ColumnDef::new(Character::MainBackpack1).integer())
                    .col(ColumnDef::new(Character::MainBackpack2).integer())
                    .col(ColumnDef::new(Character::MainBackpack3).integer())
                    .col(ColumnDef::new(Character::MainBackpack4).integer())
                    .col(ColumnDef::new(Character::MainBackpack5).integer())
                    .col(ColumnDef::new(Character::MainBackpack6).integer())
                    .col(ColumnDef::new(Character::MainBackpack7).integer())
                    .col(ColumnDef::new(Character::MainBackpack8).integer())
                    .col(ColumnDef::new(Character::MainBackpack9).integer())
                    .col(ColumnDef::new(Character::MainBackpack10).integer())
                    .col(ColumnDef::new(Character::MainBackpack11).integer())
                    .col(ColumnDef::new(Character::MainBackpack12).integer())
                    .col(ColumnDef::new(Character::MainBackpack13).integer())
                    .col(ColumnDef::new(Character::MainBackpack14).integer())
                    .col(ColumnDef::new(Character::MainBackpack15).integer())
                    .col(ColumnDef::new(Character::MainBackpack16).integer())
                    .col(ColumnDef::new(Character::Bank1).integer())
                    .col(ColumnDef::new(Character::Bank2).integer())
                    .col(ColumnDef::new(Character::Bank3).integer())
                    .col(ColumnDef::new(Character::Bank4).integer())
                    .col(ColumnDef::new(Character::Bank5).integer())
                    .col(ColumnDef::new(Character::Bank6).integer())
                    .col(ColumnDef::new(Character::Bank7).integer())
                    .col(ColumnDef::new(Character::Bank8).integer())
                    .col(ColumnDef::new(Character::Bank9).integer())
                    .col(ColumnDef::new(Character::Bank10).integer())
                    .col(ColumnDef::new(Character::Bank11).integer())
                    .col(ColumnDef::new(Character::Bank12).integer())
                    .col(ColumnDef::new(Character::Bank13).integer())
                    .col(ColumnDef::new(Character::Bank14).integer())
                    .col(ColumnDef::new(Character::Bank15).integer())
                    .col(ColumnDef::new(Character::Bank16).integer())
                    .col(ColumnDef::new(Character::Bank17).integer())
                    .col(ColumnDef::new(Character::Bank18).integer())
                    .col(ColumnDef::new(Character::Bank19).integer())
                    .col(ColumnDef::new(Character::Bank20).integer())
                    .col(ColumnDef::new(Character::Bank21).integer())
                    .col(ColumnDef::new(Character::Bank22).integer())
                    .col(ColumnDef::new(Character::Bank23).integer())
                    .col(ColumnDef::new(Character::Bank24).integer())
                    .col(ColumnDef::new(Character::Bank25).integer())
                    .col(ColumnDef::new(Character::Bank26).integer())
                    .col(ColumnDef::new(Character::Bank27).integer())
                    .col(ColumnDef::new(Character::Bank28).integer())
                    .col(ColumnDef::new(Character::BankBag1).integer())
                    .col(ColumnDef::new(Character::BankBag2).integer())
                    .col(ColumnDef::new(Character::BankBag3).integer())
                    .col(ColumnDef::new(Character::BankBag4).integer())
                    .col(ColumnDef::new(Character::BankBag5).integer())
                    .col(ColumnDef::new(Character::BankBag6).integer())
                    .col(ColumnDef::new(Character::BankBag7).integer())
                    .col(ColumnDef::new(Character::VendorBuyback1).integer())
                    .col(ColumnDef::new(Character::VendorBuyback2).integer())
                    .col(ColumnDef::new(Character::VendorBuyback3).integer())
                    .col(ColumnDef::new(Character::VendorBuyback4).integer())
                    .col(ColumnDef::new(Character::VendorBuyback5).integer())
                    .col(ColumnDef::new(Character::VendorBuyback6).integer())
                    .col(ColumnDef::new(Character::VendorBuyback7).integer())
                    .col(ColumnDef::new(Character::VendorBuyback8).integer())
                    .col(ColumnDef::new(Character::VendorBuyback9).integer())
                    .col(ColumnDef::new(Character::VendorBuyback10).integer())
                    .col(ColumnDef::new(Character::VendorBuyback11).integer())
                    .col(ColumnDef::new(Character::VendorBuyback12).integer())
                    .col(ColumnDef::new(Character::Keyring1).integer())
                    .col(ColumnDef::new(Character::Keyring2).integer())
                    .col(ColumnDef::new(Character::Keyring3).integer())
                    .col(ColumnDef::new(Character::Keyring4).integer())
                    .col(ColumnDef::new(Character::Keyring5).integer())
                    .col(ColumnDef::new(Character::Keyring6).integer())
                    .col(ColumnDef::new(Character::Keyring7).integer())
                    .col(ColumnDef::new(Character::Keyring8).integer())
                    .col(ColumnDef::new(Character::Keyring9).integer())
                    .col(ColumnDef::new(Character::Keyring10).integer())
                    .col(ColumnDef::new(Character::Keyring11).integer())
                    .col(ColumnDef::new(Character::Keyring12).integer())
                    .foreign_key(
                        ForeignKey::create()
