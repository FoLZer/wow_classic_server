...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        gameserver_entity::item_prototype::ActiveModel {
            ...
            allowable_class: ActiveValue::Set(u32::MAX as i64),
            allowable_race: ActiveValue::Set(u32::MAX as i64),
        ...
        gameserver_entity::player_start_data::ActiveModel {
            ...
            equipment_mainhand_id: ActiveValue::Set(Some(789)),
