...
pub struct Character {
    ...
    object_fields: ObjectFields<guid::GameObject>,
        ...
        Self {
            ...
            unit_fields: UnitFields {
                ...
                bytes_1: UnitFieldBytes1::new()
                    ...
                    .with_power(0)
                    .into(),
                virtual_item_slot_displays: [0; 3].into(),
                virtual_item_infos: [0; 6].into(),
                flags: 0.into(),
                aura: [0; 48].into(),
                aura_flags: [0; 6].into(),
                aura_levels: [0; 12].into(),
                aura_applications: [0; 12].into(),
                aura_state: 0.into(),
                ...
                power_cost_modifiers: [0; 7].into(),
                power_cost_multipliers: [1; 7].into(),
                _padding: 0.into(),
            },
            player_fields: PlayerFields {
                ...
                quest_log: [QuestLogFields {
                    ...
                    .into(),
                visible_items: std::array::from_fn(|_| VisibleItemFields {
                    creator: None,
                    unkn: [0; 8],
                    properties: 0,
                    _padding: 0,
                ...
                .into(),
                inv_slot_head: [0; 46].into(),
                main_backpack_slots: [0; 32].into(),
                bank_slots: [0; 48].into(),
                bank_bag_slots: [0; 12].into(),
                vendor_buyback_slots: [0; 24].into(),
                keyring_slots: [0; 64].into(),
                far_sight: None.into(),
                field_combo_target: None.into(),
                xp: 0.into(),
                next_level_xp: 100.into(),
                skill_infos: [0; 384].into(),
                ...
                explored_zones: [0; 64].into(),
                rest_state_experience: 0.into(),
                coinage: 2.into(),
                pos_stats: [0; 5].into(),
                neg_stats: [0; 5].into(),
                resistance_buff_mods_positive: [0; 7].into(),
                resistance_buff_mods_negative: [0; 7].into(),
                mod_damage_done_pos: [0; 7].into(),
                mod_damage_done_neg: [0; 7].into(),
                mod_damage_done_pct: [0; 7].into(),
                _unknown_bytes_4: 0.into(),
                ammo_id: 0.into(),
                self_res_spell: 0.into(),
                pvp_medals: 0.into(),
                buyback_prices: [0; 12].into(),
                buyback_timestamps: [0; 12].into(),
